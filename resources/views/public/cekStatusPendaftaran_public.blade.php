...
<head>
    ...
    @vite([
        'resources/css/cekStatusPendaftaran_public.css', 
        'resources/js/cekStatusPendaftaran_public.js'
    ])
</head>
...
<div class="layout-wrapper">
    ...
    <aside class="sidebar">
        <div class="sidebar-top">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="{{ route('pendaftaran.index') }}" class="menu-item">
                    <div class="menu-icon-wrapper">
    ...
    <main class="main-content">
        ...
        <div class="search-card">
            ...
            <p class="search-desc">Masukkan Email yang kamu gunakan saat mendaftar untuk melihat status pendaftaranmu.</p>
        ...
        <div class="result-area" id="resultArea" style="display:none;">
            ...
            <div class="status-card" id="cardPending" style="display:none;">
                <div class="status-header status-pending">
                    ...
                    <div>
                        <div class="status-label">Status Pendaftaran</div>
                        <div class="status-title" id="pendingTitle">MENUNGGU VERIFIKASI</div>
                    </div>
                ...
                <div class="status-body">
                    ...
                    <div class="info-banner banner-pending">
                        ...
                        <span id="pendingMessage">Pendaftaranmu sedang dalam proses verifikasi oleh panitia. Harap menunggu konfirmasi lebih lanjut melalui email.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="status-card" id="cardDitolak" style="display:none;">
                <div class="status-header status-ditolak">
                    ...
                    <div class="status-pill pill-ditolak">Dibatalkan</div>
                </div>
                ...
                <div class="status-body">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            <span class="info-label">Sesi</span>
                            <span class="info-value" id="ditolakSesi">—</span>
                        </div>
                    </div>
                    ...
                    <div class="info-banner banner-ditolak">
                        ...
                        <span>Maaf, pendaftaranmu dibatalkan. Hubungi panitia untuk informasi lebih lanjut.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="status-card" id="cardNotFound" style="display:none;">
                <div class="not-found-wrap">
                    ...
                    <p>Email yang kamu masukkan tidak tercatat dalam sistem untuk event yang dipilih. Pastikan data sudah benar atau coba event yang berbeda.</p>
