...
<body>
    ...
    <div class="sidebar-bottom">
        <a href="#" class="btn-logout">
            <img src="{{ asset('assets/Asset - Logout.png') }}" alt="icon" class="menu-icon">
            <span>Log Out</span>
        </a>
    </div>
</aside>
    ...
    <div class="meta-container">
        <div class="glass-box">
            <img src="{{ asset('assets/Asset - Kalender.png') }}" alt="date" style="width:14px;">
            <span>33 Februari, 2026</span>
        </div>
        <div class="glass-box">
            <img src="{{ asset('assets/Asset - Lokasi.png') }}" alt="location" style="width:14px;">
